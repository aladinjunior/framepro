...
class DbInstDataSource(
    private val dbInstructionsImpl: DbInstructionsImpl
     ...
     override fun saveOnRegisterDb(sheetFragment: BottomSheetDialogFragment, registerViewModel: RegisterViewModel, name: String, address: String) : Register {
         return dbInstructionsImpl.saveOnRegisterDb(sheetFragment, registerViewModel, name, address)
    }
